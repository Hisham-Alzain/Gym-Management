          ...
          <div className={styles.cards_container}>
            {[...Array(mealsNo)].map((_, mealIndex) => (
              <div key={mealIndex} className={styles.card}>
                ...
                <select
                  value={meals[mealIndex]?.meal_id || ""}
                  onChange={(e) => handleMealChange(mealIndex, 'meal_id', e.target.value)}
                >
                  <option value="" disabled>{t('components.add_diet.option1')}</option>
                ...
                <input
                  ...
                  value={meals[mealIndex]?.quantity || ""}
                ...
                <input
                  ...
                  value={meals[mealIndex]?.time_after || ""}
